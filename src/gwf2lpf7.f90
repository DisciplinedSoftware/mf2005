...
152            FORMAT(1X,'LAYER=',I3,' ROW=',I5,' COLUMN=',I5,&
     &    ' ITERATION=',I3,' TIME STEP=',I3,' STRESS PERIOD=',I4)
               CALL USTOP(' ')
            END IF
            IBOUND(J,I,K)=0
         END IF
...
!3A1----LOGARITHMIC MEAN HYDRAULIC CONDUCTIVITY
               ...
               ELSE
                  HYC=HALF*(HYC1+HYC2)
               END IF
!3A2----MULTIPLY LOGARITHMIC K BY ARITHMETIC SATURATED THICKNESS.
...
!3B1----LOGARITHMIC MEAN HYDRAULIC CONDUCTIVITY
               ...
               ELSE
                  HYC=HALF*(HYC1+HYC2)
               END IF
!3B2----MULTIPLY LOGARITHMIC K BY ARITHMETIC SATURATED THICKNESS.
...
!5A-----IN THE VERTICAL CONDUCTANCE CALCULATION, EXCEPT THAT THE NOCVCO
