MODULE PCGN
  ...
  IMPLICIT NONE
  TYPE PCGNTYPE
     INTEGER,POINTER:: FILL
     INTEGER,POINTER:: MO_ITER
     INTEGER,POINTER:: MI_ITER
     INTEGER,POINTER:: PRGUNIT
     INTEGER,POINTER:: PC_UNIT
     INTEGER,POINTER:: TS_UNIT
     INTEGER,POINTER:: CNVG_A
     INTEGER,POINTER:: DAMP_A
     DOUBLE PRECISION,POINTER:: SAV_DAMP
     DOUBLE PRECISION,POINTER:: DRELAX
     DOUBLE PRECISION,POINTER:: MAG_CLOSE
     DOUBLE PRECISION,POINTER:: SAV_CLOSE
     DOUBLE PRECISION,POINTER:: C_RATE
     DOUBLE PRECISION,POINTER:: D_RATE
     DOUBLE PRECISION,POINTER:: RCLOSE
     DOUBLE PRECISION,POINTER:: HCLOSE
     DOUBLE PRECISION,POINTER:: LIMHDCHG
     DOUBLE PRECISION,POINTER:: MIN_DAMP
     DOUBLE PRECISION,POINTER:: MIN_CLOSE
     DOUBLE PRECISION,DIMENSION(:),POINTER:: DD
     DOUBLE PRECISION,DIMENSION(:),POINTER:: DX
     DOUBLE PRECISION,DIMENSION(:),POINTER:: DY
     DOUBLE PRECISION,DIMENSION(:),POINTER:: DZ
     DOUBLE PRECISION,DIMENSION(:),POINTER:: RES
     DOUBLE PRECISION,DIMENSION(:),POINTER:: HCH
  END TYPE PCGNTYPE
  TYPE(PCGNTYPE), DIMENSION(1:10), TARGET ::PCGNDAT
  TYPE(PCGNTYPE), POINTER ::PT
  ! ...
  INTEGER,SAVE:: MGRID=0
  INTEGER,SAVE:: KITER
  INTEGER,SAVE:: KSTP
  INTEGER,SAVE:: KPER
  REAL :: HCLOSEPCGN
  ...
  DOUBLE PRECISION,PARAMETER:: TEN=1.D1
  DOUBLE PRECISION,PARAMETER:: HUNDRED=1.D2
  DOUBLE PRECISION,PARAMETER:: SQRTEN=3.16227766017
  DOUBLE PRECISION,PARAMETER:: HALF=0.5D0
  DOUBLE PRECISION,PARAMETER:: QUARTER=0.25D0
  DOUBLE PRECISION,PARAMETER:: TENTH=0.1D0
  DOUBLE PRECISION,PARAMETER:: HUNDRETH=.01D0
  DOUBLE PRECISION,PARAMETER:: MZ=TINY(ZERO)
  DOUBLE PRECISION,PARAMETER:: LARGE=HUGE(1.0_8)
...
CONTAINS
  ...
  SUBROUTINE PCGN2AR(IN,FREE_FMT,ITER_MO,IGRID) 
    ...
    REAL:: CLOSE_R
    REAL:: CLOSE_H
    CHARACTER(LEN=12):: C_VAL1
    CHARACTER(LEN=12):: C_VAL2
    CHARACTER(LEN=12):: C_VAL3
    CHARACTER(LEN=12):: C_VAL4
...
810 FORMAT (1X,/,1X,20X,'***WARNING!!!***',/, &
  ...
  SUBROUTINE PCGN2AP(HNEWAP,RHSAP,CRAP,CCAP,CVAP,HCOFAP,IBDAP, &  
    ...
    REAL,DIMENSION(*),TARGET,INTENT(IN):: CRAP
    REAL,DIMENSION(*),TARGET,INTENT(IN):: CCAP
    REAL,DIMENSION(*),TARGET,INTENT(IN):: CVAP
    REAL,DIMENSION(*),TARGET,INTENT(IN):: HCOFAP
...
530   FORMAT (/,1X,' RESIDUAL L2 NORM AT TERMINATION: ',1PE12.5)
  ...
  ! ... ***************************************************************
    SUBROUTINE NONLINEAR(MO_ITER,MI_ITER,CNVG_A,DAMP_A,IPUNIT,IGRID, &
      ...
      ! ...    ARGUMENT LIST
      ! ... -------------------------------------------------------------
      INTEGER,INTENT(IN):: MO_ITER
      INTEGER,INTENT(IN):: MI_ITER
      INTEGER,INTENT(IN):: CNVG_A
      INTEGER,INTENT(IN):: DAMP_A
      INTEGER,INTENT(IN):: IPUNIT
      INTEGER,INTENT(IN):: IGRID
      DOUBLE PRECISION,INTENT(IN):: RCLOSE
      DOUBLE PRECISION,INTENT(IN):: HCLOSE
      DOUBLE PRECISION,INTENT(IN):: SAV_DAMP
      DOUBLE PRECISION,INTENT(IN):: MAG_CLOSE
      DOUBLE PRECISION,INTENT(IN):: SAV_CLOSE
      DOUBLE PRECISION,INTENT(IN):: C_RATE
      DOUBLE PRECISION,INTENT(IN):: D_RATE
      DOUBLE PRECISION,INTENT(IN):: LIMHDCHG
      DOUBLE PRECISION,INTENT(IN):: MIN_DAMP
      DOUBLE PRECISION,INTENT(IN):: MIN_CLOSE
      ...
      INTEGER:: MHC_NODE
      INTEGER:: C_FLAG
      INTEGER,SAVE:: NET_CHANGE
      INTEGER,SAVE:: IB0_COUNT
      INTEGER,SAVE:: IB0_BASE(10)
      INTEGER,SAVE:: NC_BASE(10)
      INTEGER,SAVE:: TOT_CELLS(10)=0
      DOUBLE PRECISION:: EPS_O
      DOUBLE PRECISION:: EPS_IP
      DOUBLE PRECISION:: HTH
      DOUBLE PRECISION:: L2HR
      DOUBLE PRECISION:: RATIO_L
      DOUBLE PRECISION:: HLAST
      DOUBLE PRECISION:: HTHIS
      DOUBLE PRECISION,SAVE:: EPS_I
      DOUBLE PRECISION,SAVE:: MXHCH
      DOUBLE PRECISION,SAVE:: DDAMP
      DOUBLE PRECISION,SAVE:: RTRP=ZERO
      DOUBLE PRECISION,SAVE:: PCG_CLOSE
      ! ... =============================================================
      ! ...                         ***NOTES***
...
530   FORMAT (/,1X,I7,' TOTAL DRY CELLS BY TIME STEP',I4, &     
  ...
  SUBROUTINE CDS_RES(RTR, HNOFLO, IPUNIT, DD, DX, DY, DZ, RES)
    ...
    DOUBLE PRECISION,DIMENSION(:),INTENT(OUT):: DD
    DOUBLE PRECISION,DIMENSION(:),INTENT(OUT):: DX
    DOUBLE PRECISION,DIMENSION(:),INTENT(OUT):: DY
    DOUBLE PRECISION,DIMENSION(:),INTENT(OUT):: DZ
...
500 FORMAT(1X,'PCGN ASSEMBLER HAS DISCOVERED AN ADDITIONAL INACTIVE CELL'&
  ...
  SUBROUTINE MAX_HCH(RTR, MXHCH, MHC_NODE, IB0_COUNT, L2HR)
    ...
    ! ... ---------------------------------------------------------
    DOUBLE PRECISION, INTENT(IN) :: RTR
    DOUBLE PRECISION,INTENT(OUT):: MXHCH
    DOUBLE PRECISION,INTENT(OUT):: L2HR
    INTEGER,INTENT(OUT):: MHC_NODE
  ...
  SUBROUTINE SECONDARY_CLOSE(MXHCH,RCLOSE,HCLOSE,RTR,ICNVG,KITER,MO_ITER, &
    ...
    INTEGER,INTENT(IN):: IPUNIT
    INTEGER, INTENT(INOUT) :: ICNVG
    DOUBLE PRECISION,INTENT(IN):: MXHCH
    DOUBLE PRECISION,INTENT(IN):: RCLOSE
    DOUBLE PRECISION,INTENT(IN):: HCLOSE
    DOUBLE PRECISION,INTENT(IN):: RTR
    ! ... ---------------------------------------------------------
...
540 FORMAT (/,1X,' RESIDUAL L2 NORM AT TERMINATION: ',1PE12.5)
  ...
  SUBROUTINE DAMP_ADJ(DAMP_A,KITER,KSTP,MIN_DAMP,SAV_DAMP,EPS,MXHCH, &
    ...
    DOUBLE PRECISION,INTENT(IN):: MXHCH
    DOUBLE PRECISION,INTENT(IN):: D_RATE
    DOUBLE PRECISION,INTENT(IN):: CHGLIMIT
    DOUBLE PRECISION, INTENT(INOUT) :: DAMP
    ! ... ---------------------------------------------------------
    ! ...    LOCAL VARIABLES
    ! ... ---------------------------------------------------------
    INTEGER :: COUNT=0
    DOUBLE PRECISION:: RATIO_E
    DOUBLE PRECISION:: RATIO_H
    DOUBLE PRECISION:: LRATIO_E
    DOUBLE PRECISION:: LRATIO_R
    DOUBLE PRECISION:: RATIO_L
    DOUBLE PRECISION,SAVE:: EPS_P
    DOUBLE PRECISION,SAVE:: MXHCHP
    DOUBLE PRECISION,SAVE:: DAMPP
    ! ... ---------------------------------------------------------
    SELECT CASE(DAMP_A)
    CASE(0)
       RETURN
...
515 FORMAT (/,1X,' PRECONDITIONED CONJUGATE GRADIENT SOLVER CANNOT &
  ...
  SUBROUTINE CK_DOMAIN
    ...
    INTEGER:: MAX_LAY
    INTEGER:: MIN_LAY
    INTEGER,DIMENSION(:),ALLOCATABLE:: C_NODE
    INTEGER,DIMENSION(:),ALLOCATABLE:: CK_D
    LOGICAL :: FLAG
    ! ... ==================================================================
...
515 FORMAT (/,1X,' PARTITION',I3,' IS CONTAINED IN FOLLOWING REGION:', &
  ...
  SUBROUTINE RENUMBER (CK_D, NO_NODES,NEW_NO,OLD_NO)
    ...
    INTEGER,INTENT(IN):: NEW_NO
    INTEGER,INTENT(IN):: OLD_NO
    INTEGER :: NODE
    DO NODE=1, NO_NODES
...
110 FORMAT('Iteration,ib0_count,Damp,L2hr,Hprev,Hcurr,',   &
  ...
  SUBROUTINE PROG1OT(KITER,IB0_COUNT,RATIO_L,L2HR,HEADCHGMAX,MHC_NODE, &
    ...
    IMPLICIT NONE
    INTEGER,INTENT(IN):: KITER
    INTEGER,INTENT(IN):: IB0_COUNT
    INTEGER,INTENT(IN):: MHC_NODE
    INTEGER,INTENT(IN):: IUNIT
    INTEGER,INTENT(IN):: NCOL
    INTEGER,INTENT(IN):: NROW
    DOUBLE PRECISION,INTENT(IN):: RATIO_L
    DOUBLE PRECISION,INTENT(IN):: L2HR
    DOUBLE PRECISION,INTENT(IN):: HEADCHGMAX
    DOUBLE PRECISION,INTENT(IN):: DAMPMHC
    DOUBLE PRECISION,INTENT(IN):: HLAST
    DOUBLE PRECISION,INTENT(IN):: HTHIS
    ! ... ------------------------------------------------------------------
    ! ...    LOCAL VARIABLES
    ! ... ------------------------------------------------------------------
    INTEGER:: NRCMHC
