...
!     Version 8.0: 07-05-2016: added support for MT3D-USGS
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
!
      MODULE LMTMODULE
         IMPLICIT NONE
         INTEGER,SAVE,POINTER:: ISSMT3D
         INTEGER,SAVE,POINTER:: IUMT3D
         INTEGER,SAVE,POINTER:: ILMTFMT
         INTEGER,SAVE,POINTER:: ISFRLAKCONNECT
         INTEGER,SAVE,POINTER:: ISFRUZFCONNECT
         INTEGER,SAVE,POINTER:: ILAKUZFCONNECT
         INTEGER,SAVE,POINTER:: ISNKUZFCONNECT
         INTEGER,SAVE,POINTER:: NPCKGTXT
         INTEGER,SAVE,POINTER:: IUZFFLOWS
         INTEGER,SAVE,POINTER:: ISFRFLOWS
         INTEGER,SAVE,POINTER:: ILAKFLOWS
         INTEGER,SAVE,POINTER:: NFLOWTYPE
         INTEGER,SAVE,POINTER:: NLKFLWTYP
         INTEGER,SAVE,POINTER:: NLAKCON
         CHARACTER*16, SAVE, DIMENSION(:), POINTER :: FLOWTYPE
         CHARACTER*16, SAVE, DIMENSION(:), POINTER :: LKFLOWTYPE
        TYPE LMTTYPE
         INTEGER,POINTER:: ISSMT3D
         INTEGER,POINTER:: IUMT3D
         INTEGER,POINTER:: ILMTFMT
         INTEGER,POINTER:: ISFRLAKCONNECT
         INTEGER,POINTER:: ISFRUZFCONNECT
         INTEGER,POINTER:: ILAKUZFCONNECT
         INTEGER,POINTER:: NPCKGTXT
         INTEGER,POINTER:: ISNKUZFCONNECT
         INTEGER,POINTER:: IUZFFLOWS
         INTEGER,POINTER:: ISFRFLOWS
         INTEGER,POINTER:: ILAKFLOWS
         INTEGER,POINTER:: NFLOWTYPE
         INTEGER,POINTER:: NLKFLWTYP
         INTEGER,POINTER:: NLAKCON
...
!
!--OPEN THE LINK-MT3DMS OUTPUT FILE NEEDED BY MT3DMS
...
!
      ...
      REAL :: ZERO
      CHARACTER*16 TEXT
      DOUBLE PRECISION CCGHB
      DOUBLE PRECISION CHB
!
!--SET POINTERS FOR THE CURRENT GRID     
...
!
     ...
     &                        PXDP,PETM
      ...
      DOUBLE PRECISION HHCOF
      DOUBLE PRECISION RRHS
      DOUBLE PRECISION PXDP1
      DOUBLE PRECISION PXDP2
!
!--SET POINTERS FOR THE CURRENT GRID
! swm: already set in GWF2ETS7BD            CALL SGWF2ETS7PNT(IGRID)
!      
      TEXT='ETS'
      ZERO=0.
!
...
!
      ...
      DOUBLE PRECISION CEL
      DOUBLE PRECISION QQ
      DOUBLE PRECISION QQIN
!
!--SET POINTERS FOR THE CURRENT GRID
! swm: already set in GWF2DRT7BD      CALL SGWF2DRT7PNT(IGRID)
!      
      TEXT='DRT'
      ZERO=0.
!
...
! ******************************************************************
! SAVE SWR (SURFACE WATER ROUTING) CELL LOCATIONS AND 
! VOLUMETRIC FLOW RATES FOR USE BY MT3D.
! ******************************************************************
      USE GLOBAL,ONLY:IBOUND,NCOL,NROW,NLAY
      USE GWFSWRMODULE,ONLY:NQAQCONN,NGWET,REACH,NREACHES
      IMPLICIT NONE
      INTEGER,INTENT(IN):: ILMTFMT
      INTEGER,INTENT(IN):: IUMT3D
...
!--WRITE AN IDENTIFYING HEADER
      ...
      ENDIF
!
!--IF NO AQUIFER CONNECTIONS, SKIP
      IF(NQAQCONN.EQ.0) GO TO 9999
!
!--PROCESS EACH SWR REACH
      DO IRCH = 1, NREACHES
!
!--GET REACH LOCATION AND FLOW RATE
        IR = REACH(IRCH)%IRCH
        ...
        DO IL = REACH(IRCH)%LAYSTR, REACH(irch)%LAYEND
          ...
          END IF
!
!--WRITE SWR REACH LOCATION AND RATE
          IF (ILMTFMT.EQ.0) THEN
              WRITE(IUMT3D) IL,IR,IC,RATE
...
!--PROCESS EACH SWR REACH
      DO IRCH = 1, NREACHES
!
!--SKIP REACHES THAT ARE NOT CELL BASED
...
!
      IMPLICIT NONE
!
      CHARACTER*16 TEXT_SFR
      CHARACTER*16 TEXT_LAK
      INTEGER IC
      INTEGER IR
      INTEGER KK
      INTEGER NSFRCON
...
!                NINFLOW = NINFLOW + 1
!--A STREAM SEGMENT THAT RECEIVES TRIBUTARY FLOW MAY ALSO HAVE SPECIFIED INFLOW AS WELL
...
!      INTEGER, DIMENSION(4)     :: LKFLOWTYP
      ...
      REAL,DIMENSION(6,NLAKES):: LKFLOWVAL
      REAL,DIMENSION(6,NLAKES):: CONSOLIDATED
...
!      DEALLOCATE(LMTDAT(IGRID)%FLOWTYPE)
!      DEALLOCATE(LMTDAT(IGRID)%LKFLOWTYPE)
!
      RETURN
      END
