      MODULE GWFETSMODULE
        IMPLICIT NONE
        INTEGER,SAVE,POINTER:: NETSOP
        INTEGER,SAVE,POINTER:: IETSCB
        INTEGER,SAVE,POINTER:: NPETS
        INTEGER,SAVE,POINTER:: IETSPF
        INTEGER,SAVE,POINTER:: NETSEG
      ...
      TYPE GWFETSTYPE
        INTEGER,POINTER:: NETSOP
        INTEGER,POINTER:: IETSCB
        INTEGER,POINTER:: NPETS
        INTEGER,POINTER:: IETSPF
        INTEGER,POINTER:: NETSEG
...
!
!1------READ FLAGS SHOWING WHETHER DATA FROM PREVIOUS STRESS PERIODS ARE
!       TO BE REUSED.
      IF (NETSEG.GT.1) THEN
        IF(IFREFM.EQ.0) THEN
