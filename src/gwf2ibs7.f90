...
!    1. Print a warning message that the IBS1 Package has been superseded
!       by the SUB Package.
...
!12-----ARE CONSISTENT WITH STARTING HEADS.
...
!     ******************************************************************
!     CHECK THAT NO STRESS PERIOD IS STEADY STATE EXCEPT THE FIRST, AND
...
!4------ARE CONSISTENT WITH STEADY-STATE HEADS.
