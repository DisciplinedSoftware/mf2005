      MODULE PCGMODULE
        ...
        INTEGER,SAVE,POINTER:: NPCOND
        INTEGER,SAVE,POINTER:: NBPOL
        INTEGER,SAVE,POINTER:: IPRPCG
        INTEGER,SAVE,POINTER:: MUTPCG
        INTEGER,SAVE,POINTER:: NITER
        REAL,SAVE,POINTER:: HCLOSEPCG
        REAL,SAVE,POINTER:: RCLOSEPCG
        REAL,SAVE,POINTER:: RELAXPCG
        REAL,SAVE,POINTER:: DAMPPCG
      ...
      TYPE PCGTYPE
        ...
        INTEGER,POINTER:: NPCOND
        INTEGER,POINTER:: NBPOL
        INTEGER,POINTER:: IPRPCG
        INTEGER,POINTER:: MUTPCG
        INTEGER,POINTER:: NITER
        REAL,POINTER:: HCLOSEPCG
        REAL,POINTER:: RCLOSEPCG
        REAL,POINTER:: RELAXPCG
        REAL,POINTER:: DAMPPCG
...
!     ------------------------------------------------------------------
      ...
      DOUBLE PRECISION SRNEW
      DOUBLE PRECISION SROLD
      DOUBLE PRECISION SSCR
      DOUBLE PRECISION SSCC
      DOUBLE PRECISION SSCV
      DOUBLE PRECISION VCC
      DOUBLE PRECISION VCR
      DOUBLE PRECISION VCV
      DOUBLE PRECISION CDCC
      DOUBLE PRECISION CDCR
      DOUBLE PRECISION CDCV
      DOUBLE PRECISION PN
      DOUBLE PRECISION VN
      DOUBLE PRECISION HCHGN
      DOUBLE PRECISION RCHGN
      DOUBLE PRECISION PAP
      DOUBLE PRECISION FCC
      DOUBLE PRECISION FCR
      DOUBLE PRECISION FCV
      DOUBLE PRECISION FV
      DOUBLE PRECISION DDAMP
      DOUBLE PRECISION BIGGESTPOS
      DOUBLE PRECISION BIGGESTNEG
!
      ...
      DIMENSION P(NODES)
      DIMENSION CD(NODES)
      DIMENSION HCHG(MXITER*ITER1)
      DIMENSION LHCH(3,MXITER*ITER1)
      DIMENSION RCHG(MXITER*ITER1)
      DIMENSION LRCH(3,MXITER*ITER1)
      DIMENSION RES(NODES)
      DIMENSION HCSV(NODES)
      DIMENSION HPCG(NODES)
!     ------------------------------------------------------------------
      IF(ISS.EQ.0) THEN
        DAMP=DAMPTR
      ELSE
