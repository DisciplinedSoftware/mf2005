!  The hydrograph labels are established by the SE subroutines the
...
!    Note that there may be less than NHTOT hydrographs because some
...
25       FORMAT(' Invalid array type was found on the following',&
     &   ' record:',/,A80)
      ...
      ENDIF
!
!  Find the grid coordinates for the cell.
