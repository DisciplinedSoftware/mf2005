...
!
!-----------------------------------------------------------------------------
!       START - DUMMY MODULES FOR MODFLOW NWT - COMMENT OUT IF MODFLOW-NWT
!       DUMMY GWFNWTMODULE MODULE FOR MODFLOW NWT
      MODULE GWFNWTMODULE
        IMPLICIT NONE
...
!                 SET JAC%IU TO THE LAST ENTRY
              ...
              END DO
!
!-------------DEALLOCATE TEMPORARY STORAGE FOR RESETTING IA, JA, ISMAP, AND ICMAP
