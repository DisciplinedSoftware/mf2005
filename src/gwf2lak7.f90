...
!
!------USGS VERSION 7.1; JUNE 2006 GWF2LAK7AR; 
...
!       argument lists are defined     
      ...
      ALLOCATE(LKFLOWTYPE(6)) ! POSITION 1: STORAGE; 2: DELVOL; 3: PRECIP; 4: EVAP; 5: RUNOFF; 6: WITHDRAWAL
!
...
!
!------USGS VERSION 7.1;  JUNE 2006 GWF2LAK7RP
...
!     -----------------------------------------------------------------
      ...
      INTEGER,INTENT(IN):: IUNITSFR
      INTEGER,INTENT(IN):: IUNITUZF
...
!dep  added SURFDPTH, CONDMX,BOTLKUP,BOTLKDN  3/3/2009
      DOUBLE PRECISION BOTLK
      DOUBLE PRECISION BOTCL
      DOUBLE PRECISION CONDUC
      DOUBLE PRECISION H
      DOUBLE PRECISION FLOBOT
      DOUBLE PRECISION STGON
      DOUBLE PRECISION FLOBO3
      DOUBLE PRECISION THET1
      DOUBLE PRECISION CLOSEZERO
      DOUBLE PRECISION SURFDPTH
      DOUBLE PRECISION CONDMX
      DOUBLE PRECISION BOTLKUP
      DOUBLE PRECISION BOTLKDN
      DOUBLE PRECISION FLOTOUZF
      DOUBLE PRECISION VOL2
      DOUBLE PRECISION WITHDRW3
!!     3                 VOL2,RAMPGW,RAMPSTGO,RAMPSTGN,
!!     4                 RAMPSTGON,HTEMP,WITHDRW3  
!dep  added double precision variables
      DOUBLE PRECISION RESID1
      DOUBLE PRECISION RESID2
      DOUBLE PRECISION DERIV
      DOUBLE PRECISION DSTAGE
      DOUBLE PRECISION DLSTG
      DOUBLE PRECISION Botlake
      DOUBLE PRECISION Splakout
      DOUBLE PRECISION dy
      DOUBLE PRECISION SRFPT
      DOUBLE PRECISION HD
      DOUBLE PRECISION AREA
      DOUBLE PRECISION RAIN
      DOUBLE PRECISION EV
      DOUBLE PRECISION THCK
      DOUBLE PRECISION SSMN1
      DOUBLE PRECISION SSMX1
      DOUBLE PRECISION OUTFLOW
      DOUBLE PRECISION DSTG
      DOUBLE PRECISION VOLNEW1
      DOUBLE PRECISION VOLNEW2
      DOUBLE PRECISION STAGE2
...
!     -----------------------------------------------------------------
      ...
      DOUBLE PRECISION VOL2
      DOUBLE PRECISION FLOTOUZF
      DOUBLE PRECISION SILLELEV
      DOUBLE PRECISION ADJSTAGE
      DOUBLE PRECISION voltest
      DOUBLE PRECISION areatest
      DOUBLE PRECISION RAMPGW
      DOUBLE PRECISION RAMPSTGO
      DOUBLE PRECISION RAMPSTGN
      DOUBLE PRECISION RAMPSTGON
      DOUBLE PRECISION HTEMP
      DOUBLE PRECISION CLOSEZERO
      DOUBLE PRECISION FLOBO2
      DOUBLE PRECISION FLOBO3
      DOUBLE PRECISION DLSTG
      DOUBLE PRECISION RUNFD
      DOUBLE PRECISION AREA
      DOUBLE PRECISION RAIN
      REAL zero
      REAL FACE
...
!          ARE THE SAME AS CONNECTED SUBLAKES OF THE PRESENT LAKE SYSTEM.
...
! 7324     FORMAT(1X,5I3,2X,1P,4E10.2,10X,E10.2)
     ...
     &        BEDLAK(II),CNDFC1,CVWD2,CNDFCT(II)
!-lfk
...
!
     ...
     &         CNDFCT(II) = 1.0/(1.0/CNDFC2+1.0/CNDFC1)
        WRITE(IOUT,7325) (ILAKE(I1,II),I1=1,5),DELC(J),DELR(I),&
     &    BEDLAK(II),CNDFC1,CNDFC2,CNDFCT(II)
        END IF
      END IF
350   CONTINUE
!
...
315     WRITE(IOUT,7325) (ILAKE(I1,II),I1=1,5),DELC(J),DELR(I),&
     &             BEDLAK(II),CNDFC1,CAQ,CNDFCT(II)
      ELSE
!
!  Horizontal conductance
!
...
!          OF LAKE STAGE TO CALCULATE LAKE AREA.
...
!          OF LAKE VOLUME TO CALCULATE LAKE AREA.
...
!     FUNCTION LINEARLY INTERPOLATES BETWEEN TWO VALUES
!          OF LAKE STAGE TO CALCULATE LAKE VOLUME.
...
!     FUNCTION LINEARLY INTERPOLATES BETWEEN TWO VALUES
!          OF LAKE VOLUME TO CALCULATE LAKE STAGE.
...
!dep&rgn  FUNCTION LINEARLY INTERPOLATES BETWEEN TWO VALUES
!          OF LAKE STAGE TO CALCULATE LAKE OUTFLOW DERIVATIVE.
      USE GWFSFRMODULE, ONLY: DLKOTFLW, DLKSTAGE
      IMPLICIT NONE
      DOUBLE PRECISION STAGE
      DOUBLE PRECISION DOTFLW
      DOUBLE PRECISION FOLD
      DOUBLE PRECISION TOLF2
