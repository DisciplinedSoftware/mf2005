...
11    FORMAT(1X,'The number of parameters has exceeded the maximum')
      CALL USTOP(' ')
!
!3------Parameter is a new parameter or it was predefined in the
...
!8------any further calls to USUB2D will not reinitialize ZZ.
        IACTIVE(IP)=NI
        II=IP
        CALL USUB2D(ZZ,NCOL,NROW,II,ILAY,INIT,NSUB)
        INIT=0
...
!
!8------Copy the values from the parameter location into the front part
